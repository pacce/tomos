...
TEST(GPU, Centroid) {
    ...
    tomos::Engine engine(CL_DEVICE_TYPE_GPU);
    std::vector<mesh::Node<float>> expected = {
          {0.666666, 0.333333, 0.000000}
        , {1.333333, 0.666666, 0.000000}
        , {2.000000, 1.000000, 0.000000}
    };
    std::vector<mesh::Node<float>> actual   = engine.centroid(mesh, "./shaders/tomos.kernel");
...
TEST(GPU, Normal) {
    ...
    std::vector<mesh::Node<float>> actual   = engine.normal(mesh, "./shaders/tomos.kernel");
